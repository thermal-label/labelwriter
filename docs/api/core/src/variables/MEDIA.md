...
#### ADDRESS\_LARGE.category

> `readonly` **category**: `"address"` = `"address"`
...
> `readonly` **skus**: readonly \[`"30321"`\]

#### ADDRESS\_LARGE.targetModels
...
#### ADDRESS\_STANDARD.skus

> `readonly` **skus**: readonly \[`"30251"`, `"30252"`, `"30254"`, `"30320"`, `"30340"`\]

#### ADDRESS\_STANDARD.targetModels
...
> `readonly` **APPOINTMENT\_CARD**: `object`

#### APPOINTMENT\_CARD.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### APPOINTMENT\_CARD.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### APPOINTMENT\_CARD.heightMm

> `readonly` **heightMm**: `89` = `89`

#### APPOINTMENT\_CARD.id

> `readonly` **id**: `"appointment-card"` = `"appointment-card"`

#### APPOINTMENT\_CARD.lengthDots

> `readonly` **lengthDots**: `1051` = `1051`

#### APPOINTMENT\_CARD.name

> `readonly` **name**: `"89×51mm Appointment / Business Card"` = `"89×51mm Appointment / Business Card"`

#### APPOINTMENT\_CARD.skus

> `readonly` **skus**: readonly \[`"30374"`\]

#### APPOINTMENT\_CARD.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### APPOINTMENT\_CARD.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### APPOINTMENT\_CARD.widthMm

> `readonly` **widthMm**: `51` = `51`

### BARCODE\_DYMO\_FILE

> `readonly` **BARCODE\_DYMO\_FILE**: `object`

#### BARCODE\_DYMO\_FILE.category

> `readonly` **category**: `"barcode"` = `"barcode"`

#### BARCODE\_DYMO\_FILE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### BARCODE\_DYMO\_FILE.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### BARCODE\_DYMO\_FILE.heightMm

> `readonly` **heightMm**: `64` = `64`

#### BARCODE\_DYMO\_FILE.id

> `readonly` **id**: `"barcode-dymo-file"` = `"barcode-dymo-file"`

#### BARCODE\_DYMO\_FILE.lengthDots

> `readonly` **lengthDots**: `756` = `756`

#### BARCODE\_DYMO\_FILE.name

> `readonly` **name**: `"64×19mm Barcode / DYMO File"` = `"64×19mm Barcode / DYMO File"`

#### BARCODE\_DYMO\_FILE.skus

> `readonly` **skus**: readonly \[`"1933085"`\]

#### BARCODE\_DYMO\_FILE.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### BARCODE\_DYMO\_FILE.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### BARCODE\_DYMO\_FILE.widthMm

> `readonly` **widthMm**: `19` = `19`

### BOOK\_SPINE

> `readonly` **BOOK\_SPINE**: `object`

#### BOOK\_SPINE.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### BOOK\_SPINE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### BOOK\_SPINE.heightMm

> `readonly` **heightMm**: `38` = `38`

#### BOOK\_SPINE.id

> `readonly` **id**: `"book-spine"` = `"book-spine"`

#### BOOK\_SPINE.lengthDots

> `readonly` **lengthDots**: `449` = `449`

#### BOOK\_SPINE.name

> `readonly` **name**: `"38×25mm Book Spine"` = `"38×25mm Book Spine"`

#### BOOK\_SPINE.skus

> `readonly` **skus**: readonly \[`"30347"`\]

#### BOOK\_SPINE.targetModels
...
> `readonly` **widthMm**: `25` = `25`

### CONTINUOUS\_57MM

> `readonly` **CONTINUOUS\_57MM**: `object`

#### CONTINUOUS\_57MM.category

> `readonly` **category**: `"continuous"` = `"continuous"`

#### CONTINUOUS\_57MM.id

> `readonly` **id**: `"continuous-57"` = `"continuous-57"`

#### CONTINUOUS\_57MM.name

> `readonly` **name**: `"57mm Continuous Non-Adhesive"` = `"57mm Continuous Non-Adhesive"`

#### CONTINUOUS\_57MM.skus

> `readonly` **skus**: readonly \[`"30270"`\]

#### CONTINUOUS\_57MM.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### CONTINUOUS\_57MM.type

> `readonly` **type**: `"continuous"` = `"continuous"`

#### CONTINUOUS\_57MM.widthMm

> `readonly` **widthMm**: `57` = `57`

### DURABLE\_BLACK\_ON\_ORANGE\_12

> `readonly` **DURABLE\_BLACK\_ON\_ORANGE\_12**: `object`

#### DURABLE\_BLACK\_ON\_ORANGE\_12.background
...
> `readonly` **id**: `"d1-durable-bo-12"` = `"d1-durable-bo-12"`

#### DURABLE\_BLACK\_ON\_ORANGE\_12.material

> `readonly` **material**: `"durable"` = `"durable"`
...
#### DURABLE\_BLACK\_ON\_ORANGE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### DURABLE\_BLACK\_ON\_ORANGE\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### DURABLE\_BLACK\_ON\_ORANGE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### DURABLE\_BLACK\_ON\_ORANGE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### DURABLE\_BLACK\_ON\_WHITE\_12

> `readonly` **DURABLE\_BLACK\_ON\_WHITE\_12**: `object`

#### DURABLE\_BLACK\_ON\_WHITE\_12.background
...
> `readonly` **id**: `"d1-durable-bw-12"` = `"d1-durable-bw-12"`

#### DURABLE\_BLACK\_ON\_WHITE\_12.material
...
#### DURABLE\_BLACK\_ON\_WHITE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### DURABLE\_BLACK\_ON\_WHITE\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### DURABLE\_BLACK\_ON\_WHITE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### DURABLE\_BLACK\_ON\_WHITE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### DURABLE\_WHITE\_ON\_BLACK\_12

> `readonly` **DURABLE\_WHITE\_ON\_BLACK\_12**: `object`

#### DURABLE\_WHITE\_ON\_BLACK\_12.background
...
> `readonly` **id**: `"d1-durable-wbk-12"` = `"d1-durable-wbk-12"`

#### DURABLE\_WHITE\_ON\_BLACK\_12.material
...
#### DURABLE\_WHITE\_ON\_BLACK\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### DURABLE\_WHITE\_ON\_BLACK\_12.text

> `readonly` **text**: `"white"` = `"white"`

#### DURABLE\_WHITE\_ON\_BLACK\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### DURABLE\_WHITE\_ON\_BLACK\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### DURABLE\_WHITE\_ON\_RED\_12

> `readonly` **DURABLE\_WHITE\_ON\_RED\_12**: `object`

#### DURABLE\_WHITE\_ON\_RED\_12.background
...
> `readonly` **id**: `"d1-durable-wr-12"` = `"d1-durable-wr-12"`

#### DURABLE\_WHITE\_ON\_RED\_12.material
...
#### DURABLE\_WHITE\_ON\_RED\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### DURABLE\_WHITE\_ON\_RED\_12.text

> `readonly` **text**: `"white"` = `"white"`

#### DURABLE\_WHITE\_ON\_RED\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### DURABLE\_WHITE\_ON\_RED\_12.widthMm
...
#### FILE\_FOLDER.category

> `readonly` **category**: `"file-folder"` = `"file-folder"`
...
> `readonly` **name**: `"87×14mm File Folder"` = `"87×14mm File Folder"`

#### FILE\_FOLDER.skus

> `readonly` **skus**: readonly \[`"30327"`\]

#### FILE\_FOLDER.targetModels
...
> `readonly` **LEVER\_ARCH**: `object`

#### LEVER\_ARCH.category

> `readonly` **category**: `"shipping"` = `"shipping"`

#### LEVER\_ARCH.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### LEVER\_ARCH.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### LEVER\_ARCH.heightMm

> `readonly` **heightMm**: `190` = `190`

#### LEVER\_ARCH.id

> `readonly` **id**: `"lever-arch"` = `"lever-arch"`

#### LEVER\_ARCH.lengthDots

> `readonly` **lengthDots**: `2244` = `2244`

#### LEVER\_ARCH.name

> `readonly` **name**: `"190×59mm Lever Arch / Confirmation"` = `"190×59mm Lever Arch / Confirmation"`

#### LEVER\_ARCH.skus

> `readonly` **skus**: readonly \[`"1933087"`, `"99019"`\]

#### LEVER\_ARCH.targetModels
...
### MULTI\_PURPOSE\_EXTRA\_SMALL

> `readonly` **MULTI\_PURPOSE\_EXTRA\_SMALL**: `object`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.heightMm

> `readonly` **heightMm**: `25` = `25`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.id

> `readonly` **id**: `"multi-purpose-extra-small"` = `"multi-purpose-extra-small"`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.lengthDots

> `readonly` **lengthDots**: `295` = `295`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.name

> `readonly` **name**: `"25×13mm Extra Small (2-up)"` = `"25×13mm Extra Small (2-up)"`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.skus

> `readonly` **skus**: readonly \[`"30333"`\]

#### MULTI\_PURPOSE\_EXTRA\_SMALL.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_EXTRA\_SMALL.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### MULTI\_PURPOSE\_EXTRA\_SMALL.widthMm

> `readonly` **widthMm**: `13` = `13`

### MULTI\_PURPOSE\_LARGE

> `readonly` **MULTI\_PURPOSE\_LARGE**: `object`

#### MULTI\_PURPOSE\_LARGE.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_LARGE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### MULTI\_PURPOSE\_LARGE.heightMm

> `readonly` **heightMm**: `70` = `70`

#### MULTI\_PURPOSE\_LARGE.id

> `readonly` **id**: `"multi-purpose-large"` = `"multi-purpose-large"`

#### MULTI\_PURPOSE\_LARGE.lengthDots

> `readonly` **lengthDots**: `827` = `827`

#### MULTI\_PURPOSE\_LARGE.name

> `readonly` **name**: `"70×54mm Large"` = `"70×54mm Large"`

#### MULTI\_PURPOSE\_LARGE.skus

> `readonly` **skus**: readonly \[`"30324"`\]

#### MULTI\_PURPOSE\_LARGE.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_LARGE.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### MULTI\_PURPOSE\_LARGE.widthMm

> `readonly` **widthMm**: `54` = `54`

### MULTI\_PURPOSE\_MEDIUM

> `readonly` **MULTI\_PURPOSE\_MEDIUM**: `object`

#### MULTI\_PURPOSE\_MEDIUM.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_MEDIUM.cornerRadiusMm
...
> `readonly` **id**: `"multi-purpose-medium"` = `"multi-purpose-medium"`
...
> `readonly` **name**: `"57×32mm Medium"` = `"57×32mm Medium"`

#### MULTI\_PURPOSE\_MEDIUM.skus

> `readonly` **skus**: readonly \[`"30334"`, `"1933084"`\]

#### MULTI\_PURPOSE\_MEDIUM.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_MEDIUM.type
...
#### MULTI\_PURPOSE\_SMALL.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_SMALL.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### MULTI\_PURPOSE\_SMALL.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### MULTI\_PURPOSE\_SMALL.heightMm

> `readonly` **heightMm**: `54` = `54`

#### MULTI\_PURPOSE\_SMALL.id

> `readonly` **id**: `"multi-purpose-small"` = `"multi-purpose-small"`

#### MULTI\_PURPOSE\_SMALL.lengthDots

> `readonly` **lengthDots**: `638` = `638`

#### MULTI\_PURPOSE\_SMALL.name

> `readonly` **name**: `"54×25mm Small"` = `"54×25mm Small"`

#### MULTI\_PURPOSE\_SMALL.skus

> `readonly` **skus**: readonly \[`"30336"`, `"1976411"`\]

#### MULTI\_PURPOSE\_SMALL.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_SMALL.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### MULTI\_PURPOSE\_SMALL.widthMm

> `readonly` **widthMm**: `25` = `25`

### MULTI\_PURPOSE\_SQUARE

> `readonly` **MULTI\_PURPOSE\_SQUARE**: `object`

#### MULTI\_PURPOSE\_SQUARE.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_SQUARE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### MULTI\_PURPOSE\_SQUARE.heightMm

> `readonly` **heightMm**: `25` = `25`

#### MULTI\_PURPOSE\_SQUARE.id

> `readonly` **id**: `"multi-purpose-square"` = `"multi-purpose-square"`

#### MULTI\_PURPOSE\_SQUARE.lengthDots

> `readonly` **lengthDots**: `295` = `295`

#### MULTI\_PURPOSE\_SQUARE.name

> `readonly` **name**: `"25×25mm Square"` = `"25×25mm Square"`

#### MULTI\_PURPOSE\_SQUARE.skus

> `readonly` **skus**: readonly \[`"30332"`, `"1933083"`\]

#### MULTI\_PURPOSE\_SQUARE.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_SQUARE.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### MULTI\_PURPOSE\_SQUARE.widthMm

> `readonly` **widthMm**: `25` = `25`

### MULTI\_PURPOSE\_VIDEO\_TOP

> `readonly` **MULTI\_PURPOSE\_VIDEO\_TOP**: `object`

#### MULTI\_PURPOSE\_VIDEO\_TOP.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### MULTI\_PURPOSE\_VIDEO\_TOP.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### MULTI\_PURPOSE\_VIDEO\_TOP.heightMm

> `readonly` **heightMm**: `79` = `79`

#### MULTI\_PURPOSE\_VIDEO\_TOP.id

> `readonly` **id**: `"multi-purpose-video-top"` = `"multi-purpose-video-top"`

#### MULTI\_PURPOSE\_VIDEO\_TOP.lengthDots

> `readonly` **lengthDots**: `933` = `933`

#### MULTI\_PURPOSE\_VIDEO\_TOP.name

> `readonly` **name**: `"79×46mm Video Top"` = `"79×46mm Video Top"`

#### MULTI\_PURPOSE\_VIDEO\_TOP.skus

> `readonly` **skus**: readonly \[`"30326"`\]

#### MULTI\_PURPOSE\_VIDEO\_TOP.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### MULTI\_PURPOSE\_VIDEO\_TOP.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### MULTI\_PURPOSE\_VIDEO\_TOP.widthMm

> `readonly` **widthMm**: `46` = `46`

### NAME\_BADGE

> `readonly` **NAME\_BADGE**: `object`

#### NAME\_BADGE.category

> `readonly` **category**: `"name-badge"` = `"name-badge"`

#### NAME\_BADGE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### NAME\_BADGE.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### NAME\_BADGE.heightMm

> `readonly` **heightMm**: `102` = `102`

#### NAME\_BADGE.id

> `readonly` **id**: `"name-badge"` = `"name-badge"`

#### NAME\_BADGE.lengthDots

> `readonly` **lengthDots**: `1205` = `1205`

#### NAME\_BADGE.name

> `readonly` **name**: `"102×57mm Name Badge"` = `"102×57mm Name Badge"`

#### NAME\_BADGE.skus

> `readonly` **skus**: readonly \[`"30857"`, `"30911"`\]

#### NAME\_BADGE.targetModels
...
### NAME\_BADGE\_NON\_ADHESIVE

> `readonly` **NAME\_BADGE\_NON\_ADHESIVE**: `object`

#### NAME\_BADGE\_NON\_ADHESIVE.category

> `readonly` **category**: `"name-badge"` = `"name-badge"`

#### NAME\_BADGE\_NON\_ADHESIVE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### NAME\_BADGE\_NON\_ADHESIVE.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### NAME\_BADGE\_NON\_ADHESIVE.heightMm

> `readonly` **heightMm**: `106` = `106`

#### NAME\_BADGE\_NON\_ADHESIVE.id

> `readonly` **id**: `"name-badge-non-adhesive"` = `"name-badge-non-adhesive"`

#### NAME\_BADGE\_NON\_ADHESIVE.lengthDots

> `readonly` **lengthDots**: `1252` = `1252`

#### NAME\_BADGE\_NON\_ADHESIVE.name

> `readonly` **name**: `"106×62mm Name Badge Non-Adhesive"` = `"106×62mm Name Badge Non-Adhesive"`

#### NAME\_BADGE\_NON\_ADHESIVE.skus

> `readonly` **skus**: readonly \[`"30856"`\]

#### NAME\_BADGE\_NON\_ADHESIVE.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### NAME\_BADGE\_NON\_ADHESIVE.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### NAME\_BADGE\_NON\_ADHESIVE.widthMm
...
> `readonly` **PRICE\_TAG**: `object`

#### PRICE\_TAG.category

> `readonly` **category**: `"price-tag"` = `"price-tag"`

#### PRICE\_TAG.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### PRICE\_TAG.heightMm

> `readonly` **heightMm**: `22` = `22`

#### PRICE\_TAG.id

> `readonly` **id**: `"price-tag"` = `"price-tag"`

#### PRICE\_TAG.lengthDots

> `readonly` **lengthDots**: `260` = `260`

#### PRICE\_TAG.name

> `readonly` **name**: `"24×22mm Price Tag"` = `"24×22mm Price Tag"`

#### PRICE\_TAG.skus

> `readonly` **skus**: readonly \[`"30373"`\]

#### PRICE\_TAG.targetModels
...
> `readonly` **widthMm**: `24` = `24`

### PRICE\_TAG\_2UP

> `readonly` **PRICE\_TAG\_2UP**: `object`

#### PRICE\_TAG\_2UP.category

> `readonly` **category**: `"price-tag"` = `"price-tag"`

#### PRICE\_TAG\_2UP.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### PRICE\_TAG\_2UP.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### PRICE\_TAG\_2UP.heightMm

> `readonly` **heightMm**: `19` = `19`

#### PRICE\_TAG\_2UP.id

> `readonly` **id**: `"price-tag-2up"` = `"price-tag-2up"`

#### PRICE\_TAG\_2UP.lengthDots

> `readonly` **lengthDots**: `224` = `224`

#### PRICE\_TAG\_2UP.name

> `readonly` **name**: `"19×10mm Price Tag (2-up)"` = `"19×10mm Price Tag (2-up)"`

#### PRICE\_TAG\_2UP.skus

> `readonly` **skus**: readonly \[`"30299"`\]

#### PRICE\_TAG\_2UP.targetModels

> `readonly` **targetModels**: readonly \[`"lw"`\]

#### PRICE\_TAG\_2UP.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### PRICE\_TAG\_2UP.widthMm

> `readonly` **widthMm**: `10` = `10`

### REMOVABLE

> `readonly` **REMOVABLE**: `object`

#### REMOVABLE.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### REMOVABLE.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### REMOVABLE.heightMm

> `readonly` **heightMm**: `59` = `59`

#### REMOVABLE.id

> `readonly` **id**: `"removable"` = `"removable"`

#### REMOVABLE.lengthDots

> `readonly` **lengthDots**: `697` = `697`

#### REMOVABLE.name

> `readonly` **name**: `"59×51mm Removable"` = `"59×51mm Removable"`

#### REMOVABLE.skus

> `readonly` **skus**: readonly \[`"30370"`\]

#### REMOVABLE.targetModels
...
> `readonly` **RETURN\_ADDRESS**: `object`

#### RETURN\_ADDRESS.category

> `readonly` **category**: `"address"` = `"address"`

#### RETURN\_ADDRESS.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### RETURN\_ADDRESS.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### RETURN\_ADDRESS.heightMm

> `readonly` **heightMm**: `51` = `51`

#### RETURN\_ADDRESS.id

> `readonly` **id**: `"return-address"` = `"return-address"`

#### RETURN\_ADDRESS.lengthDots

> `readonly` **lengthDots**: `602` = `602`

#### RETURN\_ADDRESS.name

> `readonly` **name**: `"19×51mm Return Address"` = `"19×51mm Return Address"`

#### RETURN\_ADDRESS.skus

> `readonly` **skus**: readonly \[`"30330"`, `"30578"`\]

#### RETURN\_ADDRESS.targetModels
...
> `readonly` **SHELVING**: `object`

#### SHELVING.category

> `readonly` **category**: `"multi-purpose"` = `"multi-purpose"`

#### SHELVING.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### SHELVING.defaultOrientation
...
> `readonly` **name**: `"89×25mm Shelving"` = `"89×25mm Shelving"`

#### SHELVING.skus

> `readonly` **skus**: readonly \[`"1933081"`\]

#### SHELVING.targetModels
...
> `readonly` **SHIPPING\_4X6**: `object`

#### SHIPPING\_4X6.category

> `readonly` **category**: `"shipping"` = `"shipping"`

#### SHIPPING\_4X6.cornerRadiusMm

> `readonly` **cornerRadiusMm**: `3` = `3`

#### SHIPPING\_4X6.defaultOrientation

> `readonly` **defaultOrientation**: `"horizontal"` = `"horizontal"`

#### SHIPPING\_4X6.heightMm

> `readonly` **heightMm**: `152` = `152`

#### SHIPPING\_4X6.id

> `readonly` **id**: `"shipping-4x6"` = `"shipping-4x6"`

#### SHIPPING\_4X6.lengthDots

> `readonly` **lengthDots**: `1795` = `1795`

#### SHIPPING\_4X6.name

> `readonly` **name**: `"152×102mm Extra Large Shipping (4×6)"` = `"152×102mm Extra Large Shipping (4×6)"`

#### SHIPPING\_4X6.skus

> `readonly` **skus**: readonly \[`"1744907"`, `"1933086"`\]

#### SHIPPING\_4X6.targetModels

> `readonly` **targetModels**: readonly \[`"lw-wide"`\]

#### SHIPPING\_4X6.type

> `readonly` **type**: `"die-cut"` = `"die-cut"`

#### SHIPPING\_4X6.widthMm
...
> `readonly` **name**: `"102×59mm Large Shipping"` = `"102×59mm Large Shipping"`

#### SHIPPING\_LARGE.skus

> `readonly` **skus**: readonly \[`"30256"`, `"1763982"`, `"1933088"`\]

#### SHIPPING\_LARGE.targetModels
...
> `readonly` **name**: `"102×54mm Shipping"` = `"102×54mm Shipping"`

#### SHIPPING\_STANDARD.skus

> `readonly` **skus**: readonly \[`"30323"`\]

#### SHIPPING\_STANDARD.targetModels
...
### STANDARD\_BLACK\_ON\_BLUE\_12

> `readonly` **STANDARD\_BLACK\_ON\_BLUE\_12**: `object`

#### STANDARD\_BLACK\_ON\_BLUE\_12.background
...
> `readonly` **id**: `"d1-standard-bbl-12"` = `"d1-standard-bbl-12"`

#### STANDARD\_BLACK\_ON\_BLUE\_12.material

> `readonly` **material**: `"standard"` = `"standard"`
...
#### STANDARD\_BLACK\_ON\_BLUE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_BLUE\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_BLUE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_BLUE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_CLEAR\_12

> `readonly` **STANDARD\_BLACK\_ON\_CLEAR\_12**: `object`

#### STANDARD\_BLACK\_ON\_CLEAR\_12.background
...
> `readonly` **id**: `"d1-standard-bc-12"` = `"d1-standard-bc-12"`

#### STANDARD\_BLACK\_ON\_CLEAR\_12.material
...
#### STANDARD\_BLACK\_ON\_CLEAR\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_CLEAR\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_CLEAR\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_CLEAR\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_CLEAR\_19

> `readonly` **STANDARD\_BLACK\_ON\_CLEAR\_19**: `object`

#### STANDARD\_BLACK\_ON\_CLEAR\_19.background
...
> `readonly` **id**: `"d1-standard-bc-19"` = `"d1-standard-bc-19"`

#### STANDARD\_BLACK\_ON\_CLEAR\_19.material
...
#### STANDARD\_BLACK\_ON\_CLEAR\_19.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_CLEAR\_19.widthMm

> `readonly` **widthMm**: `19` = `19`

### STANDARD\_BLACK\_ON\_CLEAR\_9

> `readonly` **STANDARD\_BLACK\_ON\_CLEAR\_9**: `object`

#### STANDARD\_BLACK\_ON\_CLEAR\_9.background
...
> `readonly` **id**: `"d1-standard-bc-9"` = `"d1-standard-bc-9"`

#### STANDARD\_BLACK\_ON\_CLEAR\_9.material
...
#### STANDARD\_BLACK\_ON\_CLEAR\_9.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_CLEAR\_9.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_CLEAR\_9.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_CLEAR\_9.widthMm

> `readonly` **widthMm**: `9` = `9`

### STANDARD\_BLACK\_ON\_GREEN\_12

> `readonly` **STANDARD\_BLACK\_ON\_GREEN\_12**: `object`

#### STANDARD\_BLACK\_ON\_GREEN\_12.background
...
> `readonly` **id**: `"d1-standard-bg-12"` = `"d1-standard-bg-12"`

#### STANDARD\_BLACK\_ON\_GREEN\_12.material
...
#### STANDARD\_BLACK\_ON\_GREEN\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_GREEN\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_GREEN\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_GREEN\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_RED\_12

> `readonly` **STANDARD\_BLACK\_ON\_RED\_12**: `object`

#### STANDARD\_BLACK\_ON\_RED\_12.background
...
> `readonly` **id**: `"d1-standard-br-12"` = `"d1-standard-br-12"`

#### STANDARD\_BLACK\_ON\_RED\_12.material
...
#### STANDARD\_BLACK\_ON\_RED\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_RED\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_RED\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_RED\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_WHITE\_12

> `readonly` **STANDARD\_BLACK\_ON\_WHITE\_12**: `object`

#### STANDARD\_BLACK\_ON\_WHITE\_12.background
...
> `readonly` **id**: `"d1-standard-bw-12"` = `"d1-standard-bw-12"`

#### STANDARD\_BLACK\_ON\_WHITE\_12.material
...
#### STANDARD\_BLACK\_ON\_WHITE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_WHITE\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_WHITE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_WHITE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_WHITE\_19

> `readonly` **STANDARD\_BLACK\_ON\_WHITE\_19**: `object`

#### STANDARD\_BLACK\_ON\_WHITE\_19.background
...
> `readonly` **id**: `"d1-standard-bw-19"` = `"d1-standard-bw-19"`

#### STANDARD\_BLACK\_ON\_WHITE\_19.material
...
#### STANDARD\_BLACK\_ON\_WHITE\_19.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_WHITE\_19.widthMm

> `readonly` **widthMm**: `19` = `19`

### STANDARD\_BLACK\_ON\_WHITE\_24

> `readonly` **STANDARD\_BLACK\_ON\_WHITE\_24**: `object`

#### STANDARD\_BLACK\_ON\_WHITE\_24.background
...
> `readonly` **id**: `"d1-standard-bw-24"` = `"d1-standard-bw-24"`

#### STANDARD\_BLACK\_ON\_WHITE\_24.material
...
#### STANDARD\_BLACK\_ON\_WHITE\_24.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_WHITE\_24.widthMm

> `readonly` **widthMm**: `24` = `24`

### STANDARD\_BLACK\_ON\_WHITE\_6

> `readonly` **STANDARD\_BLACK\_ON\_WHITE\_6**: `object`

#### STANDARD\_BLACK\_ON\_WHITE\_6.background
...
> `readonly` **id**: `"d1-standard-bw-6"` = `"d1-standard-bw-6"`

#### STANDARD\_BLACK\_ON\_WHITE\_6.material
...
#### STANDARD\_BLACK\_ON\_WHITE\_6.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_WHITE\_6.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_WHITE\_6.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_WHITE\_6.widthMm

> `readonly` **widthMm**: `6` = `6`

### STANDARD\_BLACK\_ON\_WHITE\_9

> `readonly` **STANDARD\_BLACK\_ON\_WHITE\_9**: `object`

#### STANDARD\_BLACK\_ON\_WHITE\_9.background
...
> `readonly` **id**: `"d1-standard-bw-9"` = `"d1-standard-bw-9"`

#### STANDARD\_BLACK\_ON\_WHITE\_9.material
...
#### STANDARD\_BLACK\_ON\_WHITE\_9.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_WHITE\_9.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_WHITE\_9.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_WHITE\_9.widthMm

> `readonly` **widthMm**: `9` = `9`

### STANDARD\_BLACK\_ON\_YELLOW\_12

> `readonly` **STANDARD\_BLACK\_ON\_YELLOW\_12**: `object`

#### STANDARD\_BLACK\_ON\_YELLOW\_12.background
...
> `readonly` **id**: `"d1-standard-by-12"` = `"d1-standard-by-12"`

#### STANDARD\_BLACK\_ON\_YELLOW\_12.material
...
#### STANDARD\_BLACK\_ON\_YELLOW\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLACK\_ON\_YELLOW\_12.text

> `readonly` **text**: `"black"` = `"black"`

#### STANDARD\_BLACK\_ON\_YELLOW\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_YELLOW\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_BLACK\_ON\_YELLOW\_24

> `readonly` **STANDARD\_BLACK\_ON\_YELLOW\_24**: `object`

#### STANDARD\_BLACK\_ON\_YELLOW\_24.background
...
> `readonly` **id**: `"d1-standard-by-24"` = `"d1-standard-by-24"`

#### STANDARD\_BLACK\_ON\_YELLOW\_24.material
...
#### STANDARD\_BLACK\_ON\_YELLOW\_24.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLACK\_ON\_YELLOW\_24.widthMm

> `readonly` **widthMm**: `24` = `24`

### STANDARD\_BLUE\_ON\_WHITE\_12

> `readonly` **STANDARD\_BLUE\_ON\_WHITE\_12**: `object`

#### STANDARD\_BLUE\_ON\_WHITE\_12.background
...
> `readonly` **id**: `"d1-standard-blw-12"` = `"d1-standard-blw-12"`

#### STANDARD\_BLUE\_ON\_WHITE\_12.material
...
#### STANDARD\_BLUE\_ON\_WHITE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_BLUE\_ON\_WHITE\_12.text

> `readonly` **text**: `"blue"` = `"blue"`

#### STANDARD\_BLUE\_ON\_WHITE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_BLUE\_ON\_WHITE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_RED\_ON\_WHITE\_12

> `readonly` **STANDARD\_RED\_ON\_WHITE\_12**: `object`

#### STANDARD\_RED\_ON\_WHITE\_12.background
...
> `readonly` **id**: `"d1-standard-rw-12"` = `"d1-standard-rw-12"`

#### STANDARD\_RED\_ON\_WHITE\_12.material
...
#### STANDARD\_RED\_ON\_WHITE\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_RED\_ON\_WHITE\_12.text

> `readonly` **text**: `"red"` = `"red"`

#### STANDARD\_RED\_ON\_WHITE\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_RED\_ON\_WHITE\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_WHITE\_ON\_BLACK\_12

> `readonly` **STANDARD\_WHITE\_ON\_BLACK\_12**: `object`

#### STANDARD\_WHITE\_ON\_BLACK\_12.background
...
> `readonly` **id**: `"d1-standard-wbk-12"` = `"d1-standard-wbk-12"`

#### STANDARD\_WHITE\_ON\_BLACK\_12.material
...
#### STANDARD\_WHITE\_ON\_BLACK\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_WHITE\_ON\_BLACK\_12.text

> `readonly` **text**: `"white"` = `"white"`

#### STANDARD\_WHITE\_ON\_BLACK\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_WHITE\_ON\_BLACK\_12.widthMm

> `readonly` **widthMm**: `12` = `12`

### STANDARD\_WHITE\_ON\_CLEAR\_12

> `readonly` **STANDARD\_WHITE\_ON\_CLEAR\_12**: `object`

#### STANDARD\_WHITE\_ON\_CLEAR\_12.background
...
> `readonly` **id**: `"d1-standard-wc-12"` = `"d1-standard-wc-12"`

#### STANDARD\_WHITE\_ON\_CLEAR\_12.material
...
#### STANDARD\_WHITE\_ON\_CLEAR\_12.targetModels

> `readonly` **targetModels**: readonly \[`"d1"`\]

#### STANDARD\_WHITE\_ON\_CLEAR\_12.text

> `readonly` **text**: `"white"` = `"white"`

#### STANDARD\_WHITE\_ON\_CLEAR\_12.type

> `readonly` **type**: `"tape"` = `"tape"`

#### STANDARD\_WHITE\_ON\_CLEAR\_12.widthMm
